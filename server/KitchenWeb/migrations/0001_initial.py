    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('special_offering', models.BooleanField(default=False)),
                ('discount', models.IntegerField(default=False, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(30)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ManyToManyField(related_name='commands', to='accounts.Organization', verbose_name='Организации')),
            ],
            options={
